...
namespace Cactus
{
	...
	public:
		...
		FileAppender(const Cactus::String& fileName, bool bAppend, EFileEncoding encoding);
	...
	public:
		...
		RollingFileAppender(const Cactus::String& fileName, SRollingParam param, FileAppender::EFileEncoding encoding);
